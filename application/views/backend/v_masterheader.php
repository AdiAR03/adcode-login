...
<head>
  ...
  <?php
    $link   = base_url().'files/';
    $u      = $users->row_array();
    $a      = $application->row_array();
  ?>

  <link rel="shortcut icon" href="<?php echo $link.'/img_aplikasi/'.$a['icon_aplikasi']?>">
  ...
  <link rel="stylesheet" href="<?= base_url('template/adminlte/dist/');?>css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?= base_url('template/adminlte/bower_components/');?>morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?= base_url('template/adminlte/bower_components/');?>jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?= base_url('template/adminlte/bower_components/');?>bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?= base_url('template/adminlte/bower_components/');?>bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?= base_url('template/adminlte/plugins/');?>bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url('backend/user/view-profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
